...
function ConceptStep({ concept }: { concept: string }) {
  return (
    <div className="text-center space-y-6">
      ...
      <div>
        <p className="label-large text-primary uppercase tracking-wide mb-3">
          Concetto chiave
        </p>
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center gap-3 mb-2">
        ...
        <span className="label-large text-muted-foreground uppercase tracking-wide">
          Spiegazione
        </span>
      </div>
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="label-large text-tertiary uppercase tracking-wide">
          Esempio pratico
        </span>
      </div>
